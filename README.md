...
IF: -bash: electron: command not found
DO: ./node_modules/.bin/electron ./path/to/file/main.js
<br>
TUTORIAL:<br>
...
<br>
<br>
Link for the working demo hosted on Heroku: https://secured-call.herokuapp.com/